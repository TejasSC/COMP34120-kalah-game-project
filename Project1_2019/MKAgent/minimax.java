...
public static int evaluate(Board board)
{
    ...
    int seedsInSouthWell = getSeedsInStore(SOUTH);
...
public static void makeNewMove(Board board, int side, int i)
{
...
public static int main()
{
    ...
    printf("SIDE: " + bestMove.getSide() + "HOLE: " + bestMove.getHole());
